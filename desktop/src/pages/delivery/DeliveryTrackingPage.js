...
} from '../../utils/deliveryChallanPrintHtml';
...
const DeliveryTrackingPage = () => {
  ...
  const handlePrintChallan = () => {
    ...
    try {
      ...
      const printHtml = buildDeliveryChallanPrintDocument({
        challan: selectedDelivery,
        companySettings,
        items,
        sub,
        gt,
      ...
      console.log('🖨️ Print layout', DELIVERY_PRINT_LAYOUT_VERSION);
